ö8Shader "Kaijudo/Particles/Additive Always In Front" {
Properties {
...
{
  lowp vec4 tmpvar_1;
  tmpvar_1 = (((2.0 * xlv_COLOR) * _TintColor) * texture (_MainTex, xlv_TEXCOORD0));
...
void main ()
{
  ...
  tmpvar_1.w = tmpvar_4;
  lowp vec4 tmpvar_5;
  tmpvar_5 = (((2.0 * tmpvar_1) * _TintColor) * texture (_MainTex, xlv_TEXCOORD0));
