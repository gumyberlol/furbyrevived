ÿ¤Shader "RS Mobile/Specular/VertexColour/Texture/Opaque" {
Properties {
...
void main ()
{
  ...
  tmpvar_11 = (tmpvar_1 * _glesColor);
  tmpvar_1 = tmpvar_11;
  highp vec3 tmpvar_12;
  highp vec3 i_13;
  i_13 = ((_Object2World * _glesVertex).xyz - _WorldSpaceCameraPos);
  tmpvar_12 = (i_13 - (2.0 * (dot (tmpvar_4, i_13) * tmpvar_4)));
  tmpvar_2.yz = tmpvar_12.yz;
  tmpvar_2.x = -(tmpvar_12.x);
