...
void main ()
{
  ...
  tmpvar_6 = dot (xlv_TEXCOORD3, xlv_TEXCOORD3);
  lowp vec4 c_7;
  c_7.xyz = (((tmpvar_4 * _Color).xyz * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * texture (_LightTexture0, vec2(tmpvar_6)).w) * 2.0));
  c_7.w = ((texture (_Cube, tmpvar_3) * tmpvar_4.w).w * _ReflectColor.w);
  c_1.xyz = c_7.xyz;
  c_1.w = 0.0;
  _glesFragData[0] = c_1;
}
...
void main ()
{
  ...
  lowp vec4 c_5;
  c_5.xyz = (((tmpvar_4 * _Color).xyz * _LightColor0.xyz) * (max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * 2.0));
  c_5.w = ((texture (_Cube, tmpvar_3) * tmpvar_4.w).w * _ReflectColor.w);
  c_1.xyz = c_5.xyz;
  c_1.w = 0.0;
  _glesFragData[0] = c_1;
}
...
void main ()
{
  ...
  lowp vec4 c_9;
  c_9.xyz = (((tmpvar_4 * _Color).xyz * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * atten_8) * 2.0));
  c_9.w = ((texture (_Cube, tmpvar_3) * tmpvar_4.w).w * _ReflectColor.w);
  c_1.xyz = c_9.xyz;
  c_1.w = 0.0;
  _glesFragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_6 = dot (xlv_TEXCOORD3, xlv_TEXCOORD3);
  lowp vec4 c_7;
  c_7.xyz = (((tmpvar_4 * _Color).xyz * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * (texture (_LightTextureB0, vec2(tmpvar_6)).w * texture (_LightTexture0, xlv_TEXCOORD3).w)) * 2.0));
  c_7.w = ((texture (_Cube, tmpvar_3) * tmpvar_4.w).w * _ReflectColor.w);
  c_1.xyz = c_7.xyz;
  c_1.w = 0.0;
  _glesFragData[0] = c_1;
...
void main ()
{
  ...
  lightDir_2 = xlv_TEXCOORD2;
  lowp vec4 c_5;
  c_5.xyz = (((tmpvar_4 * _Color).xyz * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir_2)) * texture (_LightTexture0, xlv_TEXCOORD3).w) * 2.0));
  c_5.w = ((texture (_Cube, tmpvar_3) * tmpvar_4.w).w * _ReflectColor.w);
  c_1.xyz = c_5.xyz;
  c_1.w = 0.0;
  _glesFragData[0] = c_1;
