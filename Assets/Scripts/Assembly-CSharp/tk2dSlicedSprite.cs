...
public class tk2dSlicedSprite : tk2dBaseSprite
{
	...
	{
		Color color = _color;
		if (base.Collection.premultipliedAlpha)
		{
			color.r *= color.a;
			color.g *= color.a;
			color.b *= color.a;
	...
	{
		tk2dSpriteDefinition tk2dSpriteDefinition2 = base.Collection.spriteDefinitions[base.spriteId];
	...
	{
		if (base.GetComponent<Renderer>().sharedMaterial != base.Collection.spriteDefinitions[base.spriteId].materialInst)
		{
			base.GetComponent<Renderer>().material = base.Collection.spriteDefinitions[base.spriteId].materialInst;
		}
	}
