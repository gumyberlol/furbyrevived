...
[AddComponentMenu("NGUI/Interaction/Center On Child (with Snap)")]
public class UICenterOnChildWithSnap : MonoBehaviour
{
	...
	public virtual void Recenter(Transform closest, bool snap)
	{
		if (mDrag == null)
		{
		...
		if (closest != null)
		{
			...
			SpringPanel.Begin(mDrag.gameObject, cachedTransform.localPosition - vector4, strength).onFinished = onFinished;
		}
		else
		{
