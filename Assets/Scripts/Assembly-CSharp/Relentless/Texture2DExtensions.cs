...
namespace Relentless
{
	public static class Texture2DExtensions
	{
		...
		public static void Scale(this Texture2D tex, int newWidth, int newHeight, bool useBilinear)
		{
			TextureScale.ThreadedScale(tex, newWidth, newHeight, useBilinear);
		}

		public static void Scale(this Texture2D tex, int newWidth, int newHeight)
		{
