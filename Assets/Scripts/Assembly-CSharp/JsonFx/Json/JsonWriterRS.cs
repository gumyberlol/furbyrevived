...
{
	public class JsonWriterRS : ModelWriterRS
	{
		public class JsonFormatterRS : ITextFormatter<ModelTokenType>
		{
			...
			public JsonFormatterRS(DataWriterSettingsRS settings)
			{
				if (settings == null)
				{
		...
		public JsonWriterRS()
			: base(new DataWriterSettingsRS())
		{
		}

		public JsonWriterRS(DataWriterSettingsRS settings)
			: base((settings == null) ? new DataWriterSettingsRS() : settings)
		{
		}

		public JsonWriterRS(DataWriterSettingsRS settings, params string[] contentTypes)
			: base((settings == null) ? new DataWriterSettingsRS() : settings)
		{
			if (contentTypes == null)
			{
		...
		{
			return new JsonFormatterRS(Settings);
		}
	}
}
