ÊWShader "Unlit/Transparent Colored FONT (SoftClip)" {
Properties {
...
void main ()
{
  ...
  tmpvar_3.w = texture2D (_MainTex, xlv_TEXCOORD0).w;
...
mediump vec4 frag( in v2f IN ) {
    ...
    #line 70
    mediump vec4 col = (vec4( 1.0, 1.0, 1.0, texture( _MainTex, IN.texcoord).w) * IN.color);
